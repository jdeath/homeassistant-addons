...
This addon is based on the [docker image](https://github.com/WeeJeWel/wg-easy). A custom fork is used until requested changes are made to parent (to allow ingress and custom wireguard config location)


* All-in-one: WireGuard + Web UI.
* Ingress working with custom docker fork
...
1. Make the directory /ssl/wgeasy to store your downloaded files if not created 
1. Start the add-on.
