...
1. It will reload the URL to something like `http://192.168.1.14:51821/api/hassio_ingress/XXXXXXX/login`
...
1. If you go to http://port:ip and cannot login, make sure url looks like `http://192.168.1.14:51821/api/hassio_ingress/XXXXXXX/login`
